# Kamimusuhi G0-v4 — Predictive Invariant Grounding

**Target:** `llm_master`
**Experiment ID:** `G0-v4`
**Working directory:** `experiments/g0_v4/`
**Priority:** HIGH
...
**G0-v4 内で policy learning は行わない。**
