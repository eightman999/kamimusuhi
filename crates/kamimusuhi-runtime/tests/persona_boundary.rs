...
//!
//! The "real model" here is a local OpenAI-compatible endpoint on a real
//! socket. That is the same thing llama.cpp, Ollama and LM Studio serve; what
//! is being tested is the boundary, not any model's competence.
