...
The runtime sends a bounded JSON request to a local child process:
...
runtime errors; failures are reduced to stable error classes. Output size and
wall time are bounded.
